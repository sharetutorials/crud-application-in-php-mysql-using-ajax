...
function getAllData() {
    $.post("crud_script.php",{crudOperation:"getData"},function (allData) {
...
function deleteData(deleteId) {
    if(confirm("Are you sure to delete this ?")){
        ...
        $.post("crud_script.php",{crudOperation:"deleteData",deleteId:deleteId},function (response) {
            if (response == "deleted") {
