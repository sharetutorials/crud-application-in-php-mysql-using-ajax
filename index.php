...
<html lang="en">
	<head>
		...
		<link rel="shortcut icon" href="img/sharetutorials-favicon.png"> 
	...
	<body>
		...
		<div style="margin-top: 30px; margin-bottom: 30px;"><img width="300" src="img/sharetutorials.png" class="center-block"/></div>
		...
		<script src="js/crud_app.js"></script>
	</body>
</html>